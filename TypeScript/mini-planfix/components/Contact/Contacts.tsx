...
export default function Contacts() {
    ...
    const [contactsData, setContactsData] = useState<ContactsDetail[]>([]);
    const [filteredData, setFilteredData] = useState<ContactsDetail[]>([]);
    ...
    useEffect(() => {
        ...
        const fetchEmployeeData = async () => {
            try {
                ...
                const formattedData: ContactsDetail[] = data.contacts?.map((contact: any) => ({
                    id: contact.id,
                ...
                <ScrollView contentContainerStyle={styles.scrollContainer}>
                    {filteredData.map((employee) => (
                        <TouchableOpacity
                            ...
                            onPress={() => navigation.navigate('ContactDetail', { id: employee.id.toString() })}
                        >
